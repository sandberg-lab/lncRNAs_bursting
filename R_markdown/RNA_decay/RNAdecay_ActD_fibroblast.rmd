---
title: "RNAdecay_ActD_fibroblast"
output:
  md_document:
...
```{r Identify a subset of genes to use for normalization}
...
```{r Normalize the expression to t0 for each replicate}
...
```{r Filter and compare to previous estimates from ES cells (Herzog et al 2017), fig.height = 3, fig.width = 3}
...
```{r Compare mRNAs to lncRNAs, fig.height = 3, fig.width = 3}
...
```{r Conttrol plots, fit to observed expression, fig.height = 3, fig.width = 12 }
