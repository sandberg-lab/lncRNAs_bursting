---
title: "allelicImbalance_functionalPrediction"
output:
  md_document:
...
```{r Allelic imbalance for lncRNAs and mRNAs, fig.height = 3, fig.width = 9}
...
```{r Move lncRNA genes to 1000 random positions to evaluate coordinated allelic imbalance for lncRNA-mRNA gene pairs}
...
```{r Plot significant candidates and highlight validated candidates, fig.height = 4, fig.width = 6}
...
```{r Plot distribution of lncRNA-mRNA gene pairs, fig.height = 3, fig.width = 12}
...
```{r Plot allelic imbalance of validated candidates, fig.height = 3, fig.width = 15, echo=TRUE}
