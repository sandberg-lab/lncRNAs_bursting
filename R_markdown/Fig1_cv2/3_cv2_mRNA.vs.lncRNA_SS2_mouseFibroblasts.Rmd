---
title: "2_CV2_mRNA.vs.lncRNA_Smartseq2_mouseFibroblasts"
output:
  md_document:
...
```{r match each lncRNA to 100 mRNAs of most similar mean expression and rank CV2, fig.height = 3, fig.width = 3}
...
```{r permutation test of CV2 (lncRNA vs mRNAs) for expression matched mRNAs, fig.height = 3, fig.width = 6}
...
```{r Some more control plots for the expression matched mRNAs, fig.height = 3, fig.width = 12}
###########
