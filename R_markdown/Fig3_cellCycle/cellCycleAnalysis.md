...
# Non-win normalized data for Anova test
...
# Plot and highlight candidates (Fig 3b)
  ...
  gg <-
    ...
    geom_vline(xintercept=log2(foldSig), linetype="dashed", size=0.25, color='red') +
    geom_hline(yintercept=-log10(pSig), linetype="dashed", size=0.25, color='red') +
